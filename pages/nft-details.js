      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4 ">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase()
            ? (<p className="font-poppins dark:text-white text-nft-black-1 text-base font-normal border-x-0 border-gray p-2">You cannot purchase your own NFT.</p>)
            : (<Button btnName={`Purchase for ${nft.price} ${nftcurrency}`} classStyles="mr-5 sm:mr-0 rounded-xl" />)}
        </div>
